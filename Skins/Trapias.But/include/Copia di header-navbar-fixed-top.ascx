...
<div class="navbar navbar-fixed-top">
    ...
    <div class="container-fluid">
        ...
        <ddr:DDRMENU ID="navmain" runat="server" MenuStyle="aim"></ddr:DDRMENU>
        <ul class="nav pull-right" role="navigation">
            <li class="divider-vertical"></li>
            <li class="logincontrols"><span><i class="icon-user"></i>&nbsp;<dnn:USER ID="dnnUser" runat="server" LegacyMode="true" ShowAvatar="true" ShowUnreadMessages="false" /></span></li>
            <li class="logincontrols"><span><i class="icon-lock"></i>&nbsp;<dnn:LOGIN ID="dnnLogin" CssClass="LoginLink" runat="server" LegacyMode="true" /></span></li>
            <%--<li>
                <ul class="nav navbar-search pull-right logincontrols">
                    <li><dnn:USER ID="dnnUser" runat="server" LegacyMode="true" ShowAvatar="true" ShowUnreadMessages="false" /></li>
