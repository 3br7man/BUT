...
<span id="ClassicSearch" runat="server" visible="true" class="butsearch">
      ...
      <asp:TextBox ID="txtSearch" runat="server" CssClass="search-query" Columns="20" MaxLength="255" EnableViewState="False"></asp:TextBox>&nbsp;
